...
\titlegraphic{%
  \includegraphics[height=0.9cm]{Variabel dan Operator/logoprovikom.jpg}%
  \hspace{0.5em}%
  \includegraphics[height=0.9cm]{Variabel dan Operator/logomatematika.png}%
  \hspace{0.5em}%
  \includegraphics[height=1cm]{Variabel dan Operator/logoits.png}%
}
