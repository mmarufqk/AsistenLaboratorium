...
\titlegraphic{%
  \includegraphics[height=0.9cm]{Input dan GUI Sederhana/logoprovikom.jpg}%
  \hspace{0.5em}%
  \includegraphics[height=0.9cm]{Input dan GUI Sederhana/logomatematika.png}%
  \hspace{0.5em}%
  \includegraphics[height=1cm]{Input dan GUI Sederhana/logoits.png}%
}
