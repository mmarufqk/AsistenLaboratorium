...
\titlegraphic{%
  \includegraphics[height=0.9cm]{Struktur Kontrol 1/logoprovikom.jpg}%
  \hspace{0.5em}%
  \includegraphics[height=0.9cm]{Struktur Kontrol 1/logomatematika.png}%
  \hspace{0.5em}%
  \includegraphics[height=1cm]{Struktur Kontrol 1/logoits.png}%
}
