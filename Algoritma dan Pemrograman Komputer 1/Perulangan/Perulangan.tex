...
\titlegraphic{%
  \includegraphics[height=0.9cm]{Perulangan/logoprovikom.jpg}%
  \hspace{0.5em}%
  \includegraphics[height=0.9cm]{Perulangan/logomatematika.png}%
  \hspace{0.5em}%
  \includegraphics[height=1cm]{Perulangan/logoits.png}%
}
